...
const translations = {
    de: {
        ...
        about_p2: "<p>Man sieht, ich hege eine gewisse Leidenschaft für die <span class='highlight'>Kryptographie</span> <br>Ein Themengebiet, mit dem ich Jahrelang gar nichts anfangen konnten. Die, die sich dafür interessiert haben, waren für mich immer die absoluten Nerds, die ungeduscht in ihren Kellern sitzen. (Ich persönlich <span class='highlight'>dusche regelmäßig</span>!)</p>",
        about_p3: "<p>Kurz zu meinem Werdegang: <br>Im Alter von 11 Jahren startete ich parallel Java und Python zu lernen. Mit 13 begann ich ab und an mich mit Webentwicklung zu beschäftigen. Entwickelte Spiele, Portale und Homepages. <br> Mit 15 Jahren wechselte ich (übrigens) auf Arch Linux. <br>Andere Linux Distros nutzte ich ebenfalls. Alpine auf dem Server, Void auf meinem alten Laptop und mit Mint und Zorin habe ich gearbeitet, um meinen Familienmitgliedern Linux schmackhaft zu machen.</p>",
        about_p4: "<p>Wenn ich gerade nicht programmiere oder an meinem alten Laptop herumschraube, dann bin ich viel draußen unterwegs. Gehe wandern, in Seen schwimmen oder Rennradfahren.<br>Auch habe ich einen kleinen Faible für alles mit Motoren. Zum Beispiel baue ich gern an meinem alten Fahrrad, an welches ich einen 100ccm Motor gebastelt habe. </p>",
