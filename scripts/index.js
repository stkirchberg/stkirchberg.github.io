...
const translations = {
    ...
    en: {
        ...
        about_p1: "<p>Usually, I describe myself with the high-sounding title: “<span class='highlight'>Founder</span> and <span class='highlight'>Lead Developer</span> of <span class='highlight'>Vincere</span>”.<br> Like I said. High-sounding. <br>Vincere could be described as a small <span class='highlight'>chat room in the Tor network</span>. A test project for me to try my hand at cryptography. <br>The core is the interplay of Curve25519, AES-IGE (modeled after Telegram), and SHA-256. <br>In the future, I want to use a <span class='highlight'>hybrid PQC protocol</span>. X-Wing, probably. However, that will be difficult to implement without completely blowing up the network latency. Keyword: 512-byte cells.</p>",
        about_p2: "<p>As you can see, I have a certain passion for <span class='highlight'>cryptography</span>. <br>A field I couldn't really do anything with for years. The people who were interested in it were always the absolute nerds to me, sitting unwashed in their basements. (Personally, I <span class='highlight'>shower regularly</span>!)</p>",
        about_p3: "<p>A quick look at my background: <br>At the age of 11, I started learning <span class='highlight'>Java</span> and <span class='highlight'>Python</span> in parallel. At 13, I began to dabble in <span class='highlight'>web development</span> every now and then. I developed games, portals, and homepages. <br> At 15, I switched (by the way) to <span class='highlight'>Arch Linux</span>. <br>I also used other Linux distributions. <span class='highlight'>Alpine</span> on the server, <span class='highlight'>Void</span> on my old laptop, and I worked with Mint and Zorin to make it appealing to my family members.</p>",
        about_p4: "<p>When I'm not programming or tinkering with my old laptop, I spend a lot of time outdoors. I go <span class='highlight'>hiking</span>, <span class='highlight'>swimming</span> in lakes, or <span class='highlight'>road cycling</span>.<br>I also have a slight soft spot for anything with <span class='highlight'>engines</span>. For example, I like building on my old bicycle, onto which I have cobbled a <span class='highlight'>100cc engine</span>. </p>",
