...
const translations = {
    ...
    en: {
        ...
        about_p3: "<p>A quick look at my background: <br>At the age of 11, I started learning <span class='highlight'>Java</span> and <span class='highlight'>Python</span> in parallel. At 13, I began to dabble in <span class='highlight'>web development</span> every now and then. I developed games, portals, and homepages. <br> At 15, I switched to <span class='highlight'>Arch Linux</span> (btw). <br>I also used other Linux distributions. <span class='highlight'>Alpine</span> on the server, <span class='highlight'>Void</span> on my old laptop, and I worked with Mint and Zorin to make it appealing to my family members.</p>",
